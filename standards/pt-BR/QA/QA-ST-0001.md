...
Versão 70% formal / 30% operacional — otimizado para Engenharia + QA.
...
1. Criar **Task no Jira** com tudo documentado.
2. Atribuir **ao time do Japão**.
...
# ✔ CHECKLIST IMPRIMÍVEL (Ultra Direto)
