...
Phiên bản 70% chính thức / 30% vận hành — được tối ưu hóa cho Kỹ thuật + QA.
...
1. Tạo **Nhiệm vụ Jira** với mọi thứ được ghi chép.
2. Phân công **cho nhóm Nhật Bản**.
3. Ghi lại trong Slack / bình luận Nhiệm vụ rằng:

   * danh sách kiểm tra đã được thực thi
...
# ✔ DANH SÁCH KIỂM TRA CÓ THỂ IN (Siêu Trực tiếp)
